        ...
        <div className='container mx-auto px-8 md:px-16 lg:px-24'>
            ...
            <div className='flex flex-col md:flex-row items-center md:space-x-12'>
               ...
               <div className='flex-1'>
                <p className='text-lg mb-8'>I'm a passionate full-stack developer with a focus on building modern and responsive
                    web-applications. With a strong foundation in both frontend and backend technologies, 
                    I strive to create seamless and efficient UXs.
                </p>
                <div className='space-y-4'>
                    ...
                    <div className='mt-12 flex justify-between text-center'>
                        ...
                        <div>
                            <h3 className='text 2xl font-bold text-transparent bg-clip-text bg-gradient-to-r
                            from-green-400 to-blue-500'>50+</h3>
